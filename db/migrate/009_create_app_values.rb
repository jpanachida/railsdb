class CreateAppValues < ActiveRecord::Migration
  ...
  def self.up
    ...
    # Export format
    AppValue.create( :id => RailsdbConfig::ExportFormat.csv,
                  :dict_id => RailsdbConfig::Dictionary.export_format,
                  :name => 'CSV',
                  :desc => 'Comma Separated Values',
                  :code => 'CSV' )
    AppValue.create( :id => RailsdbConfig::ExportFormat.tsv,
                  :dict_id => RailsdbConfig::Dictionary.export_format,
                  :name => 'TSV',
                  :desc => 'Tab Separated Values',
                  :code => 'TSV' )
#    AppValue.create( :id => RailsdbConfig::ExportFormat.xml,
#                  :dict_id => RailsdbConfig::Dictionary.export_format,
#                  :name => 'XML',
#                  :desc => 'Extensible Markup Language',
#                  :code => 'XML' )
#    AppValue.create( :id => RailsdbConfig::ExportFormat.yaml,
#                  :dict_id => RailsdbConfig::Dictionary.export_format,
#                  :name => 'YAML',
#                  :desc => 'YAML Ain\'t a Markup Language',
#                  :code => 'YAML' )
#    AppValue.create( :id => RailsdbConfig::ExportFormat.sql,
#                  :dict_id => RailsdbConfig::Dictionary.export_format,
#                  :name => 'SQL',
...
#                  :code => 'SQL' )
    ...
    # Packaging format
    AppValue.create( :id => RailsdbConfig::PackagingFormat.zip,
                  :dict_id => RailsdbConfig::Dictionary.export_packaging,
                  :name => 'Zip',
                  :desc => 'Zip archival format',
                  :code => 'ZIP' )
    AppValue.create( :id => RailsdbConfig::PackagingFormat.bzip2,
                  :dict_id => RailsdbConfig::Dictionary.export_packaging,
                  :name => 'Bzip2',
                  :desc => 'Bzip2 archival format',
                  :code => 'BZIP2' )
    AppValue.create( :id => RailsdbConfig::PackagingFormat.tgz,
                  :dict_id => RailsdbConfig::Dictionary.export_packaging,
                  :name => 'Tgz',
